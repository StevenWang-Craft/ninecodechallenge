...
using TvProgramJsonProcessor.Controllers;
...
namespace TvProgramJsonProcessor.Tests
{
    [TestClass]
    public class TestTvProgramJsonProcessorController
    {
